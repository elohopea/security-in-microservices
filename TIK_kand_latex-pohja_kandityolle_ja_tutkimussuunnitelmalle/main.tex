...
% 2-osainen otsikko:
\title{Security in Microservice Architecture \\[5mm] --- Impact of the Transition from a Monolith to Microservices}
...
\YEAR{2020}
\DATE{20. joulukuu 2020}
\ENDATE{December 20, 2020}
...
\KEYWORDS{monoliitti, mikropalvelu, arkkitehtuuri, tietoturva, muutosprosessi}
\ENKEYWORDS{monolith, microservice, architecture, security, transition}
