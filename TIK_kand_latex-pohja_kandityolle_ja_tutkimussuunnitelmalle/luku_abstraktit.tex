...
\begin{enabstract}
    \begin{sloppypar}
        ...
        This style does not scale nor lend itself to agile development practices, 
        as well as the microservices architectural style does. Thus, these services might benefit 
        from an architectural change to using microservices. Since the architectures
    ...
    \begin{sloppypar}
        ...
        considerations and possible solutions to these security issues.
    \end{sloppypar}
    \begin{sloppypar}
        % (2) aineisto ja menetelmät (erittäin lyhyesti);
