...
\begin{sloppypar}
    ...
    independently deployable, is modeled around the business domain, owns the data
...
\begin{sloppypar}
    ...
    new version that needs to be rolled into production. The upgrade service
    is responsible for doing this. Service discovery is a service that is used
...
\begin{sloppypar}
    ...
    system. The data moves in the data-plane. Each microservice is accompanied by
