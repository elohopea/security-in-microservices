...
\begin{sloppypar}
    ...
    system without business logic "smart endpoints and dumb pipes", decentralized
...
\begin{sloppypar}
    ...
    successful case a session is created for the process. 
\end{sloppypar}
\begin{figure}[h]
...
\begin{sloppypar}
    ...
    a basic bearer token based authentication and
...
\begin{sloppypar}
    ...
    as one of the choices. This was found to be troublesome by .
...
\begin{sloppypar}
    ...
    with in reasonable time frame the service is deemed non operational and a new
...
\end{sloppypar}
\begin{sloppypar}
    Service mesh also allows for multi cloud installations. 
\end{sloppypar}
...
\begin{sloppypar}
    ...
    consist of addresses, secrets, and other information that alter the
    behavior of the system. Secrets refer to credentials, connection strings,
...
\begin{sloppypar}
    ...
    implemented by in house developers and thus more costs are incurred upfront
