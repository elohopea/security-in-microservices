...
\begin{sloppypar}
    ...
    presented layered as in figure \ref{fig:Defense_in_depth}. Each of these layers
    should have security features and a breach in one should not compromise
    those features on an inner layer of the system.
\end{sloppypar}
\begin{sloppypar}
    ...
    instances this might be applicable but for all web services this might not
    be feasible.
\end{sloppypar}
\begin{figure}[h]
