...
\begin{sloppypar}
    ...
    \ref{fig:TOKEN_AUTH}. A user enters credentials to login, and with these
...
\begin{sloppypar}
    ...
    as the OAuth 2.0 flow, and the token sent to the client application is a
    JavaScript Object Notation Web Token (JWT).
\end{sloppypar}

\subsection{JWT}
\begin{sloppypar}
    JWT is a format to represent claims. It consists of base64 encoded, points
...
\begin{sloppypar}
    ...
    \citet{secchalmsa}. In this thesis, REST API will be examined further.
\end{sloppypar}
...
\begin{sloppypar}
    ...
    locate running services and as a service to which self-registration is
