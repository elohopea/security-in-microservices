...
\end{sloppypar}
\begin{sloppypar}
    Requests sent to other microservices through a network are much slower
...
\begin{sloppypar}
    ...
    k8s. All of these tools have to be correctly configured and used
...
\begin{sloppypar}
    ...
    controlled by the Control plane. The microservices do not have
...
\end{sloppypar}
\begin{sloppypar}
    Is the Service Mesh compatible with the Smart endpoints dumb pipes?
\end{sloppypar}
\begin{sloppypar}
\end{sloppypar}
\begin{sloppypar}
