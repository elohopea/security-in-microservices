...
\begin{sloppypar}
    ...
    to be secure the defending developers have to find all of the bugs whereas
...
\begin{sloppypar}
    ...
    MSA, the service should own its own data. When ever information is available
    ...
    implementation has to take this into account. The service must adhere to
...
\begin{sloppypar}
    ...
    All these tools have to be correctly configured and used according to
