...
\section{Monolith to Microservices}
\begin{sloppypar}
...
\subsubsection{Authentication in Monolith}
\begin{sloppypar}
...
\subsubsection{Authorization in Monolith}
\begin{sloppypar}
...
\subsubsection{Authorization in Microservice Architecture}
...
\subsection{Session}
\subsubsection{Session in Monolith}
\subsubsection{Session in Microservice Architecture}
...
\section{Java Script Object Notation Web Token (JWT)}
\begin{sloppypar}
    ...
    signed and encrypted \citep{RFC7519}. The keys can contain authorization 
    information as oppose to a session in the server side.
\end{sloppypar}
