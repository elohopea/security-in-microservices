...
\begin{sloppypar}
    ...
    specific task to perform. This follows the Model-View-Controller (MVC) design 
    pattern \citep{trygvemvc}. The UI is the View, the business logic is the 
    Controller, and the database is the Model.
\end{sloppypar}
\begin{sloppypar}
    \citet{fowlerlewisms} define the microservice styles as follows: 
    ...
    business capability rather a design pattern such as the previously mentioned MVC, 
    a team should responsible of their product for it's full service life, 
    the services are to contain the logic and communicate using "dumb pipes",
    \textbf{Decentralized Governance,}
    \textbf{Decentralized Data Management,}
    \textbf{Infrastructure Automation,}
    \textbf{Design for failure, and}
    \textbf{Evolutionary Design.}
\end{sloppypar}
\begin{figure}[h]
